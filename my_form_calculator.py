...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_13 = QtWidgets.QPushButton(self.tabWidgetPage1)
        self.pushButton_13.setText("")
        self.pushButton_13.setObjectName("pushButton_13")
        self.gridLayout.addWidget(self.pushButton_13, 0, 0, 1, 1)
        self.pushButton_14 = QtWidgets.QPushButton(self.tabWidgetPage1)
        self.pushButton_14.setText("")
        self.pushButton_14.setObjectName("pushButton_14")
        self.gridLayout.addWidget(self.pushButton_14, 0, 1, 1, 1)
        self.pushButton_15 = QtWidgets.QPushButton(self.tabWidgetPage1)
        self.pushButton_15.setText("")
        self.pushButton_15.setObjectName("pushButton_15")
        self.gridLayout.addWidget(self.pushButton_15, 0, 2, 1, 1)
        self.pushButton_clear = QtWidgets.QPushButton(self.tabWidgetPage1)
        ...
        self.tabWidget_numbers.addTab(self.tab_3, "")
        self.tab_4 = QtWidgets.QWidget()
        self.tab_4.setObjectName("tab_4")
        self.tabWidget_numbers.addTab(self.tab_4, "")
        ...
        self.tabWidget_actions.addTab(self.tab, "")
        ...
        self.tabWidget_actions.addTab(self.tab_2, "")
    ...
    def retranslateUi(self, Form):
        ...
        self.tabWidget_numbers.setTabText(self.tabWidget_numbers.indexOf(self.tab_3), _translate("Form", "Надстр."))
        self.tabWidget_numbers.setTabText(self.tabWidget_numbers.indexOf(self.tab_4), _translate("Form", "Подстр."))
        ...
        self.tabWidget_actions.setTabText(self.tabWidget_actions.indexOf(self.tab), _translate("Form", "Арифметика"))
        self.tabWidget_actions.setTabText(self.tabWidget_actions.indexOf(self.tab_2), _translate("Form", "Инженерный"))
